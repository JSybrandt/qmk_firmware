...
*/
  ...
  [_NV] = LAYOUT(
    ...
    _______, KC_END,  _______, _______, _______, _______, KC_BSPC, KC_ENT,   KC_DEL, _______, _______, _______, _______,          _______,
  ...
  [_CM] = LAYOUT(
    ...
    _______,  VIM_Q,   VIM_W,  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
